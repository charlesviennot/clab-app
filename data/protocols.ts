...
export const STRENGTH_PROTOCOLS = {
  ...
  hypertrophy: {
    push: [ 
      { name: "Développé Couché (Barre)", sets: 4, reps: "8-10", rest: "2 min", rpe: 8, note: "Pecs / Force", imageKeyword: "barbell bench press", instructions: "Pieds ancrés, omoplates resserrées. Descendez la barre au milieu des pecs.", imageUrl: "" },
      { name: "Développé Incliné (Haltères)", sets: 4, reps: "10-12", rest: "90s", rpe: 8, note: "Haut des Pecs", imageKeyword: "incline dumbbell press", instructions: "Banc à 30-45°. Étirez bien en bas, resserrez en haut sans claquer.", imageUrl: "" },
      { name: "Développé Militaire (Assis)", sets: 4, reps: "10-12", rest: "90s", rpe: 8, note: "Épaules", imageKeyword: "dumbbell shoulder press seated", instructions: "Contrôlez la descente (3 sec) pour maximiser le temps sous tension.", imageUrl: "https://i.postimg.cc/T1vJpxSR/dev_militaire.png" },
      { name: "Élévations Latérales", sets: 4, reps: "15-20", rest: "45s", rpe: 9, note: "Deltoïde Latéral", imageKeyword: "dumbbell lateral raise", instructions: "Bras légèrement fléchis. Montez les coudes, pas les mains.", imageUrl: "https://i.postimg.cc/Xq6kpWh7/elevation_late_rale.png" },
      { name: "Extensions Triceps Poulie", sets: 4, reps: "12-15", rest: "45s", rpe: 9, note: "Triceps", imageKeyword: "tricep pushdown cable", instructions: "Coudes collés au corps. Seuls les avant-bras bougent.", imageUrl: "https://i.postimg.cc/prQYj7bn/Extensions_Triceps_Poulie.png" },
      { name: "Écarté Poulie Vis-à-vis", sets: 3, reps: "15-20", rest: "45s", rpe: 9, note: "Finition Pecs", imageKeyword: "cable crossover fly", instructions: "Cherchez la contraction maximale en croisant les mains.", imageUrl: "https://i.postimg.cc/9M7Bm0Lf/ecarte_poulie.png" }
    ],
    pull: [
      { name: "Tractions (ou Tirage Vertical)", sets: 4, reps: "8-12", rest: "2 min", rpe: 8, note: "Dos Largeur", imageKeyword: "lat pulldown gym", instructions: "Tirez vers le haut de la poitrine. Sortez la cage thoracique.", imageUrl: "https://i.postimg.cc/Lsg7r9F4/tirage_vertical.png" },
      { name: "Rowing Barre (Buste Penché)", sets: 4, reps: "8-10", rest: "90s", rpe: 8, note: "Dos Épaisseur", imageKeyword: "barbell bent over row", instructions: "Buste penché à 45°. Tirez vers le nombril en resserrant les omoplates.", imageUrl: "https://i.postimg.cc/3xcVSyVw/rowing.png" },
      { name: "Tirage Horizontal (Poulie)", sets: 3, reps: "12", rest: "90s", rpe: 8, note: "Milieu du Dos", imageKeyword: "seated cable row", instructions: "Gardez le dos droit, tirez les coudes en arrière.", imageUrl: "" },
      { name: "Curl Barre", sets: 4, reps: "10-12", rest: "60s", rpe: 9, note: "Biceps", imageKeyword: "barbell bicep curl", instructions: "Coudes fixes. Ne pas utiliser le dos pour lancer la barre.", imageUrl: "https://i.postimg.cc/fT56dqvY/curl_barre.png" },
      { name: "Curl Marteau (Haltères)", sets: 3, reps: "12", rest: "60s", rpe: 9, note: "Brachial", imageKeyword: "dumbbell hammer curl", instructions: "Prise marteau (neutre). Cible l'épaisseur du bras.", imageUrl: "https://i.postimg.cc/QdtvJg6n/Hammer_curl.png" },
      { name: "Face Pull", sets: 3, reps: "15-20", rest: "45s", rpe: 8, note: "Arrière d'épaule", imageKeyword: "face pull cable", instructions: "Tirez la corde vers le visage en écartant les coudes.", imageUrl: "" }
    ],
    legs: [ 
      { name: "Squat (Barre Libre)", sets: 4, reps: "8-10", rest: "3 min", rpe: 8, note: "Base Jambes", imageKeyword: "barbell squat", instructions: "Amplitude complète. Le creux de la hanche doit passer sous le genou.", imageUrl: "https://i.postimg.cc/ry7vNRBY/squat.png" },
      { name: "Presse à Cuisses", sets: 4, reps: "10-15", rest: "2 min", rpe: 9, note: "Volume Quads", imageKeyword: "leg press machine", instructions: "Pieds largeur épaules. Descendez genoux vers épaules.", imageUrl: "https://i.postimg.cc/tgD5S8YP/legs_press.png" },
      { name: "Fentes Bulgares", sets: 3, reps: "10/jambe", rest: "90s", rpe: 9, note: "Unilatéral", imageKeyword: "bulgarian split squat", instructions: "Pied arrière surélevé. Descendez droit vers le sol.", imageUrl: "" },
      { name: "Leg Extension", sets: 3, reps: "15", rest: "60s", rpe: 9, note: "Isolation Quads", imageKeyword: "leg extension machine", instructions: "Contractez fort en haut, retenez la descente.", imageUrl: "" },
      { name: "Leg Curl (Allongé ou Assis)", sets: 4, reps: "12-15", rest: "60s", rpe: 9, note: "Ischios", imageKeyword: "lying leg curl machine", instructions: "Contrôlez la phase retour (excentrique).", imageUrl: "https://i.postimg.cc/6Qz0jFyn/Legs_curl.png" },
      { name: "Mollets (Debout ou Presse)", sets: 4, reps: "15-20", rest: "45s", rpe: 9, note: "Mollets", imageKeyword: "standing calf raise machine", instructions: "Extension maximale sur la pointe des pieds. Pause en haut.", imageUrl: "https://i.postimg.cc/brS9vJL1/mollet_debout.png" }
    ],
    shoulders_arms: [
      { name: "Développé Militaire (Barre)", sets: 4, reps: "8-10", rest: "2 min", rpe: 8, note: "Base Épaules", imageKeyword: "standing barbell military press", instructions: "Debout, gainage solide. Poussez la barre au-dessus de la tête.", imageUrl: "" },
      { name: "Élévations Latérales (Poulie ou Haltères)", sets: 4, reps: "15-20", rest: "45s", rpe: 9, note: "Deltoïde Latéral", imageKeyword: "cable lateral raise", instructions: "Tension continue à la poulie. Montez les coudes.", imageUrl: "" },
      { name: "Oiseau (Banc Incliné ou Poulie)", sets: 4, reps: "15", rest: "45s", rpe: 8, note: "Arrière d'épaule", imageKeyword: "rear delt fly", instructions: "Cible l'arrière de l'épaule. Mouvement contrôlé.", imageUrl: "" },
      { name: "Curl Biceps Incliné", sets: 4, reps: "10-12", rest: "60s", rpe: 9, note: "Biceps Chef Long", imageKeyword: "incline dumbbell curl", instructions: "Banc à 45°. Laissez les bras pendre derrière le corps.", imageUrl: "" },
      { name: "Barre au Front (Skullcrusher)", sets: 4, reps: "10-12", rest: "60s", rpe: 8, note: "Triceps", imageKeyword: "skullcrusher ez bar", instructions: "Allongé, descendez la barre EZ vers le front. Coudes serrés.", imageUrl: "" },
      { name: "Extension Triceps Corde", sets: 3, reps: "15", rest: "45s", rpe: 9, note: "Chef Latéral Triceps", imageKeyword: "tricep rope pushdown", instructions: "Écartez la corde en bas du mouvement.", imageUrl: "" }
    ],
    chest_back: [
      { name: "Développé Couché (Barre)", sets: 4, reps: "8-10", rest: "2 min", rpe: 8, note: "Pecs", imageKeyword: "barbell bench press", instructions: "Base de la poussée.", imageUrl: "" },
      { name: "Développé Incliné (Barre ou Haltères)", sets: 4, reps: "10", rest: "90s", rpe: 8, note: "Haut Pecs", imageKeyword: "incline barbell press", instructions: "Banc à 30°. Touchez le haut de la poitrine.", imageUrl: "" },
      { name: "Tirage Vertical (Prise Large)", sets: 4, reps: "10-12", rest: "90s", rpe: 8, note: "Dos Largeur", imageKeyword: "wide grip lat pulldown", instructions: "Tirez vers la poitrine.", imageUrl: "" },
      { name: "Rowing Haltère (Unilatéral)", sets: 4, reps: "10/bras", rest: "60s", rpe: 8, note: "Dos Épaisseur", imageKeyword: "dumbbell row one arm", instructions: "En appui sur un banc. Tirez l'haltère vers la hanche.", imageUrl: "" },
      { name: "Écarté Couché (Haltères ou Poulie)", sets: 3, reps: "15", rest: "60s", rpe: 9, note: "Isolation Pecs", imageKeyword: "dumbbell flyes bench", instructions: "Ouvrez la cage thoracique. Légère flexion des coudes.", imageUrl: "" },
      { name: "Pull-over", sets: 3, reps: "15", rest: "60s", rpe: 8, note: "Dos/Pecs", imageKeyword: "dumbbell pullover bench", instructions: "Allongé en travers du banc. Descendez l'haltère derrière la tête.", imageUrl: "" }
    ]
  },
  street_workout: {
    push: [
