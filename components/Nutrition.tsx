...
import { Plus, Trash2, Search, Flame, Droplet, Wheat, Dumbbell, ChevronRight, Apple, ScanBarcode, Minus, Utensils } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in slide-in-from-right-4 pb-24">
            ...
            {showFoodSearch && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/90 backdrop-blur-sm animate-in fade-in">
                    <div className="bg-white dark:bg-slate-800 w-full max-w-md rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[80vh] animate-in zoom-in-95">
                        <div className="p-4 border-b border-slate-100 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 flex items-center gap-3">
                            ...
                            <input 
                                ...
                                className="flex-1 bg-transparent outline-none font-bold text-slate-700 dark:text-white"
                                value={searchTerm}
                            ...
                            {filteredFood.map((food, idx) => (
                                <div key={idx} onClick={() => addFood(food, 100)} className="p-3 hover:bg-slate-50 dark:hover:bg-slate-700 rounded-xl cursor-pointer flex items-center justify-between group transition border border-transparent hover:border-slate-200 dark:hover:border-slate-600">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <div className="text-[9px] font-bold text-slate-300 group-hover:text-slate-400">
